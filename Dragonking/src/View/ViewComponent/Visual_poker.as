package View.ViewComponent 
{
	...
	public class Visual_poker  extends VisualHandler
	{
		...
		public function init():void
		{
			...
			bankerCon.Create_by_list(2, ["pokerback"], 0 , 0, 2, 165, 0, "Bet_");
			...
			playerCon.Create_by_list(2, ["pokerback"], 0 , 0, 2, 165, 0, "Bet_");
			...
			riverCon.CleanList();
			//riverCon.CustomizedFun = pokerUtil.hidepoker;			
			riverCon.Create_by_list(2, ["pokerback"], 0 , 0, 2, 165, 0, "Bet_");
			riverCon.autoClean = true;
		...
		public function Clean_poker():void
		{
			...
			{				
				...
				mypoker.Create_by_list(2, ["pokerback"], 0 , 0, 2, 165, 0, "Bet_");
				mypoker.container.x = 1310;
				mypoker.container.y = 580;
			}
			...
			{				
				...
				mypoker.CustomizedFun = pokerUtil.hidepoker;
				mypoker.Create_by_list(2, ["pokerback"], 0 , 0, 2, 165, 0, "Bet_");
				mypoker.container.x = 320;
				mypoker.container.y = 580;
			}
			
			if ( Get(modelName.RIVER_POKER) != null) 
			{				
				mypoker = Get(modelName.RIVER_POKER);
				mypoker.CleanList();
				mypoker.CustomizedFun = pokerUtil.hidepoker;
				mypoker.Create_by_list(2, ["pokerback"], 0 , 0, 2, 165, 0, "Bet_");
				mypoker.container.x = 820;
				mypoker.container.y = 580;		
			}
		...
		public function playerpokerupdate(type:Intobject):void
		{
			...
			var Mypoker:Array =   _model.getValue(type.Value);			
				utilFun.Log("pokerupdate "+Mypoker);
