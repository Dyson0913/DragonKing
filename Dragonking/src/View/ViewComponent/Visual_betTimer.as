...
{	
	...
	public class Visual_betTimer  extends VisualHandler
	{
		...
		{			
			...
			coin_cancel.container.x = 457;
			coin_cancel.container.y = 662;			
			...
			coincancel_trans.container.x = 457;
			coincancel_trans.container.y = 662;
		...
		{			
			//停止所有Timer
			for each(var timer_mc:* in Get("coin_cancel").ItemList) {
