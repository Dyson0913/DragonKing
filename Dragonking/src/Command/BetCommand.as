package Command 
{
	...
	public class BetCommand 
	{
		...
		public function bet_init():void
		{
			...
			_model.putValue(modelName.COIN_STACK_XY,   [ [-45, -30], [593, -30],  [280, 23], [895, -30], [-350, -32], [250, -182]]);
			
			_model.putValue(modelName.COIN_CANCEL_XY,   [ [145, 211], [783, 211],  [472, 264], [1085, 211], [-159, 210], [440, 60]]);			
		...
		public function re_bet():void
		{
			...
			utilFun.Log("total_rebet_amount: " + total_rebet_amount);
